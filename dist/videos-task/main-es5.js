...
var AppComponent = /** @class */ (function () {
    ...
    AppComponent.prototype.showModalLogin = function () {
        this.showModal = true;
    };
    ...
    AppComponent.prototype.hideModalLogin = function () {
        this.showModal = false;
    };
    AppComponent.prototype.selectMovies = function () {
        this.isMoviesSelected = true;
    };
    AppComponent.prototype.selectChannels = function () {
...
var HeaderComponent = /** @class */ (function () {
    ...
    Object.defineProperty(HeaderComponent.prototype, "user", {
        ...
        set: function (value) {
            ...
            var name = src_app_constants_constants__WEBPACK_IMPORTED_MODULE_3__["CONSTANTS"].USERS[0].name;
        },
        enumerable: true,
        configurable: true
    });
...
var ModalLoginComponent = /** @class */ (function () {
    function ModalLoginComponent(authService) {
...
var MoviesComponent = /** @class */ (function () {
    function MoviesComponent(getMoviesService) {
...
var GetMoviesChannelsService = /** @class */ (function () {
    function GetMoviesChannelsService() {
    }
    GetMoviesChannelsService.prototype.getMovies = function () {
        return _constants_constants__WEBPACK_IMPORTED_MODULE_2__["CONSTANTS"].MOVIES;
    };
    GetMoviesChannelsService.prototype.getChannels = function () {
    ...
    return GetMoviesChannelsService;
}());
...
var LocalStorageService = /** @class */ (function () {
    ...
    LocalStorageService.prototype.getUserFromLocalStorage = function () {
        return localStorage.getItem(this.key);
    };
    LocalStorageService.prototype.addUserToLocalStorage = function (name) {
        localStorage.setItem(this.key, name);
    };
    LocalStorageService.prototype.removeUserFromLocalStorage = function () {
